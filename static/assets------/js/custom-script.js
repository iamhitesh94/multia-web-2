...
$(document).ready(function() {
	...
	/*|| Menu js ST ||*/
	jQuery(document).on("click", ".humburg-menu a",function(e) {
		e.preventDefault();
	...
	jQuery(document).on("keyup keydown", "form .input-text", function(){
		var value = jQuery(this).val();
		if(value === ''){
			jQuery(this).parents('.input-row').removeClass('filled');
		}else{
			jQuery(this).parents('.input-row').addClass('filled');
		}
	})
